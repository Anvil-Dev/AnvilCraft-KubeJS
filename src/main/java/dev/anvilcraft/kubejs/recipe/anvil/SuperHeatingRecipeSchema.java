...
public interface SuperHeatingRecipeSchema {
    ...
    class SuperHeatingKubeRecipe extends AnvilCraftKubeRecipe {
        public SuperHeatingKubeRecipe cauldron(ResourceLocation fluid) {
            this.setValue(FLUID, fluid);
            this.save();
            return this;
        }

        public SuperHeatingKubeRecipe cauldron(Block cauldron) {
            return this.cauldron(WrapUtils.cauldron2Fluid(cauldron));
        }

        public SuperHeatingKubeRecipe transform(ResourceLocation transform) {
            this.setValue(TRANSFORM, transform);
            this.save();
            return this;
        }

        public SuperHeatingKubeRecipe transform(Block transform) {
            return this.transform(WrapUtils.cauldron2Fluid(transform));
        }

        public SuperHeatingKubeRecipe produceFluid(boolean produceFluid) {
        ...
        public SuperHeatingKubeRecipe consumeFluid(boolean consumeFluid) {
        ...
        public SuperHeatingKubeRecipe result(ItemStack result, float chance) {
