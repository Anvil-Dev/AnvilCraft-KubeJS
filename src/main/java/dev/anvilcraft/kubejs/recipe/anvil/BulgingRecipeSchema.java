...
public interface BulgingRecipeSchema {
    ...
    class BulgingKubeRecipe extends AnvilCraftKubeRecipe {
        ...
        public BulgingKubeRecipe requiresTag(String ingredient, int count) {
            this.computeIfAbsent(INGREDIENTS, ArrayList::new)
                .add(ItemIngredientPredicate.of(TagKeyWrapper.fromString(ingredient, Registries.ITEM)).withCount(count).build());
            this.save();
            return this;
        }

        public BulgingKubeRecipe requiresTag(String ingredient) {
